...
//默认选中颜色
#define FUDaySelectColor      [UIColor lightTextColor]

//默认非本月日历颜色
#define FUOtherDayColor       [UIColor lightTextColor]

// 默认标题字体
#define FUTextFont            [UIFont systemFontOfSize:14]

//默认选中字体
#define FUTextSelectFont      [UIFont systemFontOfSize:14]

//默认周标题高度
#define FUWeekHeight          35

//默认日高度
#define FUDayHeight           70
